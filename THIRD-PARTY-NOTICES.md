...
Nothing third-party. The five images that ship are generated by
`tools/make-backdrops.js`, which is in this repository, and are covered by Fetch's own
licence along with the rest of it. A backdrop someone drops into the folder themselves
is theirs and is never distributed.
